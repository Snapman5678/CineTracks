package com.example.movie_catalog_service.security;

import com.example.movie_catalog_service.config.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Secured endpoints
                .requestMatchers("/api/movie-catalog/auth/**").authenticated()
